...
1. Update the version number in [`MainApp.java`](https://github.com/AY2526S1-CS2103T-F13-4/tp/tree/master/src/main/java/greynekos/greybook/MainApp.java).
1. Tag the repo with the version number. e.g. `v0.1`
1. Github Actions CI will automatically create a new release with the JAR file.
1. Update the release with the release notes.
