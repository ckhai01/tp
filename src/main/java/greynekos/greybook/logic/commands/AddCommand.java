...
public class AddCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Adds a person to the greybook book. " + "Parameters: "
    ...
    public static final String MESSAGE_DUPLICATE_PERSON = "This person already exists in the greybook book";
